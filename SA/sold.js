...
//Vendas
    ...
    var auxLoja = new Array();
    var auxVendedor = new Array();
    var auxClientes = new Array();
    var auxProdutos = new Array();
    var auxDetVendas = new Array();

function salvarInfoVendas(){
    var lojaVendas = document.getElementById("lojaSelect").value;
    var vendedorVendas = document.getElementById("vendedorSelect").value; 
    var clientesVendas = document.getElementById("clienteSelect").value;
    var produtosVendas = document.getElementById("produtosSelect").value;
    var detalhesVendas = document.getElementById("detalhesInput").value;

    localStorage.setItem("lojaSelect", lojaVendas);
    localStorage.setItem("vendedorSelect", vendedorVendas);
    localStorage.setItem("clienteSelect", clientesVendas);
    localStorage.setItem("produtosSelect", produtosVendas);
    localStorage.setItem("detalhesInput", detalhesVendas);

    auxLoja.push(lojaVendas);
    auxVendedor.push(vendedorVendas);
    auxClientes.push(clientesVendas);
    auxProdutos.push(produtosVendas);
    auxDetVendas.push(detalhesVendas);

    alert("Recebido pelo sistema.");
    console.log("OK.");
}
function salvarInfo(){
